package com.okbeanok.tropicapi.api.database;
...
public class SQLiteConnector implements DatabaseConnector {
    ...
    private final TropicAPI tropicAPI;
    private HikariDataSource hikari;
    private final AtomicInteger openConnections;
    private final Object lock;

    public SQLiteConnector(TropicAPI tropicAPI, String hostname, int port, String database, String username, String password, boolean useSSL, int poolSize) {
        this.tropicAPI = tropicAPI;
        ...
        try {
            ...
            this.tropicAPI.getLogger().severe("Failed to connect to the MySQL server. Are your credentials correct?");
            ex.printStackTrace();
        }
    }
    ...
    public void connect(ConnectionCallback callback) {
        ...
        try (Connection connection = this.hikari.getConnection()) {
            ...
            this.tropicAPI.getLogger().severe("An error occurred executing a MySQL query: " + ex.getMessage());
            ex.printStackTrace();
        } finally {
